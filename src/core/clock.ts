 ...
 * this file), so a shift can be driven by a scripted clock in tests rather
...
/**
 * The one real clock instance UI code should pass around. A single shared
 * instance keeps its identity stable across renders, which matters for hooks
 * that take it as an effect dependency.
 */
